...
odoo.define('pos_retail_standard.model', function (require) {
    ...
    models.PosModel = models.PosModel.extend({
        ...
        async _validate_by_manager(title) {
            ...
            let popup_title = this.env._t('Choice 1 Manager Approve for: ');
            if (title) {
                popup_title += ' : ' + title;
            }
        ...
        initialize: function (session, attributes) {
            ...
            priceListObject.fields.push('id', 'currency_id');
        ...
        async scan_product(parsed_code) {
            ...
            if (lots && lots.length) {
                ...
                let {confirmed, payload: lot} = await Gui.showPopup('SelectionPopup', {
        ...
        //     _super_PosModel.set_synch.call(this, status, pending);
        //     console.log('[set_synch] status: ' + status + ' pending: ' + pending)
        // },
...
//     switchSign: function () {
//         window.posmodel.switchSign = this;
//         if (window.posmodel.config.validate_change_minus) {
//             return window.posmodel.gui.show_popup('ask_password', {
//                 title: 'Pos pass pin ?',
//                 body: 'Please use pos security pin for unlock',
//                 confirm: function (value) {
//                     let pin;
//                     if (window.posmodel.config.manager_validate) {
//                         let user_validate = window.posmodel.user_by_id[this.pos.config.manager_user_id[0]];
//                         pin = user_validate['pos_security_pin']
//                     } else {
//                         pin = window.posmodel.user.pos_security_pin
//                     }
//                     if (value != pin) {
//                         return window.posmodel.gui.show_popup('dialog', {
//                             title: 'Wrong',
