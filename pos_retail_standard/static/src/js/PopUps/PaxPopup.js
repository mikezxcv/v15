odoo.define('pos_retail_standard.PaxPopup', function(require) {
    'use strict';
    ...
    // formerly PaxPopupWidget
    class PaxPopup extends AbstractAwaitablePopup {
        /**
         * @param {Object} props
    ...
    PaxPopup.template = 'PaxPopup';
    PaxPopup.defaultProps = {
        confirmText: 'Ok',
        cancelText: 'Cancel',
        title: 'Confirm ?',
        body: '',
    ...
    Registries.Component.add(PaxPopup);
