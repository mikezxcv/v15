...
class PosConfig(models.Model):
    ...
    promotion_auto_add = fields.Boolean(
        ...
        help='Auto checking promotions rule and reward \n'
             'And add to order cart, if have any change cart items')
    ...
    qrcode_receipt = fields.Text(
        'QrCode Link',
        help='QRCode link display on receipt',
    ...
    rounding_manual = fields.Boolean(
        'Rounding Manual',
        help='Allow rounding manual by cashier, example: total paid is 101 USD, cashier can rounding to 100 USD')
    ...
    cart_width = fields.Integer(
        'Cart List Width (%)',
        help='Width of Cart List, suggest is 30 (%)',
        default=30
    )
