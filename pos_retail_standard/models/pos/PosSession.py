...
class PosSession(models.Model):
    ...
    def checkingOpenedTime(self, session_id):
        _logger.info('[checkingOpenedTime] %s ' % session_id)
        return fields.Datetime.to_string(self.browse(session_id).opened_at)
